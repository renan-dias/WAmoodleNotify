...
/**
 *  Moodle Whatsapp notification plugin version info
 *
...
$plugin->version    = 2022082401;           // The current plugin version (Date: YYYYMMDDXX).
$plugin->requires   = 2021041200;             // Requires this Moodle version.
$plugin->component  = 'WAmoodleNotify';  // Full name of the plugin (used for diagnostics).
